...
def analytics_category_tab():
   ...
   if st.button("Get Analytics"):
      ...
      df_stored = df.sort_values(by="Percentage", ascending=False)


      st.title("Expense Breakdown by Category")
      st.bar_chart(data=df_stored.set_index("Category")["Percentage"], width=0, height=0, use_container_width=True)
